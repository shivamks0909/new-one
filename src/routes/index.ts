...
const STATUS_DEFINITIONS: Record<string, { title: string; subtitle: string; category: string; badgeText: string; badgeBg: string; badgeColor: string; glowColor: string; illustration: string; loi: string }> = {
  complete: {
